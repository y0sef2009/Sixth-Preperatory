export const subjects = [
  {
    ...
    icon: "∑",
    color: "#4d65d8",
    division: { singular: "فصل", plural: "فصول" },
    description: "مساحة مخصصة لتنظيم فصول الرياضيات وموادها.",
  },
  {
    id: "physics",
    name: "الفيزياء",
    ...
    color: "#397ca3",
    division: { singular: "فصل", plural: "فصول" },
    description: "مساحة مخصصة لتنظيم فصول الفيزياء وموادها.",
  },
  {
    id: "chemistry",
    name: "الكيمياء",
    ...
    color: "#7657a8",
    division: { singular: "فصل", plural: "فصول" },
    description: "مساحة مخصصة لتنظيم فصول الكيمياء وموادها.",
  },
  {
    id: "biology",
    name: "الأحياء",
    ...
    color: "#3b8968",
    division: { singular: "فصل", plural: "فصول" },
    description: "مساحة مخصصة لتنظيم فصول الأحياء وموادها.",
  },
  {
    id: "arabic",
    name: "اللغة العربية",
    icon: "ض",
    color: "#bc714b",
    division: { singular: "موضوع", plural: "مواضيع" },
    description: "مساحة مخصصة لتنظيم مواضيع اللغة العربية وموادها.",
  },
  {
    id: "english",
    ...
    icon: "En",
    color: "#36818b",
    division: { singular: "وحدة", plural: "وحدات" },
    description: "مساحة مخصصة لتنظيم وحدات اللغة الإنجليزية وموادها.",
  },
  {
    id: "french",
    name: "اللغة الفرنسية",
    ...
    color: "#536db3",
    division: { singular: "موضوع", plural: "مواضيع" },
    description: "مساحة مخصصة لتنظيم مواضيع اللغة الفرنسية وموادها.",
  },
  {
    id: "islamic",
